...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var result = Emps.Where(emp => emp.Salary == Emps.Max(e => e.Salary));
        }
        ...
        {
            var result = Emps.Where(e => e.Job == "Frontend programmer").OrderByDescending(e => e.HireDate).First();
        }
        ...
        {
            var result = Emps.Aggregate((e1, e2) => e1.Salary > e2.Salary ? e1 : e2);
        }
